 ...
 */
function pmprodon_pmpro_checkout_before_change_membership_level() {
...
add_action( 'pmpro_checkout_before_processing', 'pmprodon_pmpro_checkout_before_change_membership_level', 1 );
